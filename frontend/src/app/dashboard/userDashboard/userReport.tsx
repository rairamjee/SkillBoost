...
function UserReport() {
  ...
  const progressChartData = employeeReportDetails.map(
    (report): { date: string; score: number } => {
        ...
        <div className="flex gap-4">
          <Card className="bg-transparent border-none w-[400px] h-[400px]">
            <CardHeader>
              ...
              <CardDescription>Areas of performance</CardDescription>
            </CardHeader>
            <CardContent>
              <RadarChart
                outerRadius={90}
