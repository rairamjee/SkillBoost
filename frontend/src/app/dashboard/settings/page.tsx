    ...
    <div className="ml-4">
      ...
      <Accordion type="single" collapsible className="w-1/3 mt-8">
        <AccordionItem value="item-1">
          ...
          <AccordionContent className="">General Setting one</AccordionContent>
          <AccordionContent>General Setting two</AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-2">
          <AccordionTrigger className="font-bold">Security</AccordionTrigger>
          <AccordionContent>Setting 1</AccordionContent>
          <AccordionContent>Setting 2</AccordionContent>
          <AccordionContent>Setting 3</AccordionContent>
        </AccordionItem>
